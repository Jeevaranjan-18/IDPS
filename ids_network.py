"""
Enhanced Network-based Intrusion Detection System (NIDS)
Detects: Port Scans, DDoS, SSH Attacks, File Transfers, Anomalies
"""
...
class EnhancedNetworkIDS:
    def __init__(self, interface=None, enable_email=True):
        ...
        self.ssh_threshold = 5  # Failed attempts in 60 seconds
    ...
    def detect_ssh_attack(self, src_ip, packet):
        ...
        if dst_port == 22:
            ...
            if packet.haslayer(Raw):
                ...
                # Detect SSH banner/version exchange
                if b'SSH-' in payload:
    ...
    def detect_ftp_activity(self, src_ip, packet):
        """Detect FTP file transfer activities"""
        if not packet.haslayer(TCP):
            return None
        
        dst_port = packet[TCP].dport
        
        # FTP control (21) or data (20) port
    ...
    def detect_http_activity(self, packet):
        """Detect HTTP/HTTPS suspicious activities"""
        if not packet.haslayer(TCP):
            return None
    ...
    def process_packet(self, packet):
        ...
        # Detect HTTP suspicious activity
